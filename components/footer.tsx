...
export function Footer() {
  return (
    <footer className="bg-dark-grey text-white border-t border-white/10">
        ...
        <div className="grid md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-6">
              ...
              <span className="font-serif text-2xl font-bold text-white">Ceylon RS Tours</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["About Us", "Our Packages", "Gallery", "Travel Blog", "Contact Us"].map((item) => (
                <li key={item}>
                  <Link href="#" className="text-white/60 hover:text-tropical-turquoise transition-colors text-sm">
                    {item}
                  </Link>
                </li>
              ))}
      ...
      <div className="border-t border-white/10 bg-black/20 py-6">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/40 text-xs">© {new Date().getFullYear()} Ceylon RS Tours. All rights reserved.</p>
